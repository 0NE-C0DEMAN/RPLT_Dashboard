...
def render() -> None:
    ...
    # ── Row 4: Composite dual-axis time history ──────────────────────
    ...
    # both stay visually readable. Implements John's review request for
    # "two data series, with the second series plotted on a secondary
    # vertical axis" applied to load+vel, load+accel, load+disp,
    # vel+disp, accel+vel, accel+disp combinations.
...
# ── Composite dual-axis time history (Row 4) ─────────────────────────────────
_COMPOSITE_PAIRS = [
